      ...
      >
        ...
        <ul className="navbar-nav media-nav ml-auto">
          <li className="nav-item linkedIn-icon">
            <a
              href="https://www.linkedin.com/in/qi-zhang-0226/"
              target="_blank"
          ...
          <li className="nav-item github-icon">
            <a
              href="https://github.com/qzhang0226"
              target="_blank"
              rel="noopener noreferrer"
            >
...
const Wrapper = styled("section")`
  height: ${(props: WrapperProps) =>
    props.className === "scrolledWrapper" ? "40px" : "180px"};
  box-shadow: ${(props: WrapperProps) =>
    props.className === "scrolledWrapper" && "0px 0px 3px 0px darkgrey"};
...
const HeaderWrapper = styled("div")`
  ...
  /* margin-top: ${(props: WrapperProps) =>
    props.className === "scrolledHeaderWrapper" ? "0" : "2.5em"}; */
  opacity: ${(props: WrapperProps) =>
    props.className === "scrolledHeaderWrapper" ? "0" : "1"};
  height: ${(props: WrapperProps) =>
    props.className === "scrolledHeaderWrapper" ? "0" : "auto"};
  word-spacing: 0;
  transition: all 0.3s ease-in-out;
  p {
    float: none;
